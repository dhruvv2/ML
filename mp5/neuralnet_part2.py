...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        #https://stackoverflow.com/questions/61794587/runtime-error-shape-is-invalid-for-input
        self.conv1 = nn.Conv2d(3, 6, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(6, 16, 5)
        self.fc1 = nn.Linear(256, 140)
...
def fit(train_set,train_labels,dev_set,epochs,batch_size=100):
    ...
    #optimizer = optim.SGD(net.parameters(), lrate, momentum=0.9)
    optimizer = optim.Adagrad(net.parameters(), lrate)
